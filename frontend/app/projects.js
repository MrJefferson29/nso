...
const Culture = [
    {
        ...
        progress: 75, // Fixed progress percentage
    },
    {
        id: 2,
        goal: '500,000 CFA',
        ...
        progress: 40, // Fixed progress percentage
    },
    {
        id: 3,
        goal: '150,000 CFA',
        ...
        image: require('../assets/images/1.jpeg'),
        progress: 60, // Fixed progress percentage
    },
    {
        id: 4,
        goal: '400,000 CFA',
        ...
        image: require('../assets/images/2.jpeg'),
        progress: 90, // Fixed progress percentage
    },
];
            ...
            <ScrollView contentContainerStyle={styles.container}>
                {filteredCulture.map((culture) => (
                    <TouchableOpacity
                        key={culture.id}
                        style={styles.card}
                        onPress={() => handleImagePress(culture.id)}
                    >
                        ...
                        <View style={styles.text}>
                            <View style={styles.icon}>
                                ...
                                <Text style={{ color: '#D8C9AE', textDecorationLine: 'underline' }}>
                                    {' '}{culture.location}{' '}
                                </Text>
                            </View>
                            ...
                            <View style={styles.progressContainer}>
                                <View
                                    style={[styles.progressBar, { width: `${culture.progress}%` }]}
                                />
                            </View>
                            <Text style={styles.progressText}>
                                {culture.progress}% of {culture.goal}
                            </Text>
                        </View>
                    </TouchableOpacity>
                ))}
